                ...
                <button
                    onClick={async () => {
                        try {
                            ...
                            let creds = await client2.credentials().list('recipient',CredentialTypes.received,'')
                            await client1.credentials().list('issuer',CredentialTypes.issued,'')
                            let said = creds[0]['sad']['d']
                            let resp = await client2.credentials().export('recipient',said)
                            console.log(resp)
