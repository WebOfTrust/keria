...
import {Dict, Ident, Ilks, Serials, versify, Versionage} from "../../src/keri/core/core";
...
describe('Prefixer', () => {
    it('should create autonomic identifier prefix using derivation as determined by code from ked', async () => {
        ...
        let verkey = new Uint8Array([172, 114, 218, 200, 51, 126, 153, 114, 175, 235, 96, 192, 140, 82, 215, 215, 246, 57, 200, 69, 30, 210, 240, 61, 96, 247, 191, 138, 24, 138, 96, 113])
        let prefixer = new Prefixer({raw: verkey, code: MtrDex.Ed25519})
        assert.equal(prefixer.code, MtrDex.Ed25519)
        assert.equal(prefixer.qb64, "DKxy2sgzfplyr-tgwIxS19f2OchFHtLwPWD3v4oYimBx")
        ...
        assert.equal(prefixer.qb64, 'ELEjyRTtmfyp4VpTBTkv_b6KONMS1V8-EW-aGJ5P_QMo')
