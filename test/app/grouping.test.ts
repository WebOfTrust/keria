...
describe('Grouping', () => {
        ...
        it('Groups', async () => {
            ...
            await groups.getRequest('ELI7pg979AdhmvrjDeam2eAO2SR5niCgnjAJXJHtJose00')
            lastCall = fetchMock.mock.calls[fetchMock.mock.calls.length - 1]!
            assert.equal(lastCall[0]!, url + '/multisig/request/ELI7pg979AdhmvrjDeam2eAO2SR5niCgnjAJXJHtJose00')
