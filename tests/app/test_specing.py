...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an alias '
                      ...
                      '{"get": {"summary": "Get list of agent identifiers", "description": "Get the '
                      'list of identifiers associated with this agent", "tags": '
                      ...
                      '"properties": {"words": {"type": "array", "description": "random challenge '
                      'word list", "items": {"type": "string"}}}}}}}}}}, "/contacts": {"get": '
                      '{"summary": "Get list of contact information associated with remote '
                      'identifiers", "description": "Get list of contact information associated with '
                      'remote identifiers.  All information is metadata and kept in local storage '
                      ...
                      'notifications for the controller of the agent", "description": "Get list of '
                      'notifications for the controller of the agent.  Notifications will be sorted '
                      ...
                      'associated with remote identifier", "description": "Delete contact '
                      'information associated with remote identifier", "tags": ["Contacts"], '
                      ...
                      'information associated with single remote identifier", "description": "Get '
                      'contact information associated with single remote identifier.  All '
                      ...
                      'with remote identifier prefix.  All information is metadata and kept in local '
                      ...
                      'identifier.", "description": "Uploads an image to associate with identifier.", '
