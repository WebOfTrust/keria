...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert "/identifiers/{name}/endroles/{cid}/{role}/{eid}" in paths
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an alias '
                      ...
                      'event database"}}}}, "/identifiers": {"get": {}, "post": {}}, "/challenges": '
                      '{"get": {"summary": "Get list of agent identfiers", "description": "Get the '
                      'list of identfiers associated with this agent", "tags": '
                      '["Challenge/Response"], "parameters": [{"in": "query", "name": "strength", '
                      '"schema": {"type": "int"}, "description": "cryptographic strength of word '
                      'list", "required": false}], "responses": {"200": {"description": "An array '
                      'of Identifier key state information", "content": {"application/json": '
                      '{"schema": {"description": "Randon word list", "type": "object", '
                      '"properties": {"words": {"type": "array", "description": "random challange '
                      'word list", "items": {"type": "string"}}}}}}}}}}, "/contacts": {"get": '
                      '{"summary": "Get list of contact information associated with remote '
                      'identfiers", "description": "Get list of contact information associated with '
                      'remote identfiers.  All information is metadata and kept in local storage '
                      'only", "tags": ["Contacts"], "parameters": [{"in": "query", "name": "group", '
                      '"schema": {"type": "string"}, "required": false, "description": "field name '
                      'to group results by"}, {"in": "query", "name": "filter_field", "schema": '
                      '{"type": "string"}, "description": "field name to search", "required": '
                      'false}, {"in": "query", "name": "filter_value", "schema": {"type": '
                      '"string"}, "description": "value to search for", "required": false}], '
                      '"responses": {"200": {"description": "List of contact information for remote '
                      'identifiers"}}}}, "/notifications": {"get": {"summary": "Get list of '
                      'notifcations for the controller of the agent", "description": "Get list of '
                      'notifcations for the controller of the agent.  Notifications will be sorted '
                      'by creation date/time", "parameters": [{"in": "query", "name": "last", '
                      '"schema": {"type": "string"}, "required": false, "description": "qb64 SAID '
                      'of last notification seen"}, {"in": "query", "name": "limit", "schema": '
                      '{"type": "integer"}, "required": false, "description": "size of the result '
                      'list.  Defaults to 25"}], "tags": ["Notifications"], "responses": {"200": '
                      '{"description": "List of contact information for remote identifiers"}}}}, '
                      '"/oobi": {"get": {}}, "/": {"post": {"summary": "Accept KERI events with '
                      ...
                      '"object", "description": "KERI event message"}}}}, "responses": {"204": '
                      ...
                      '"/identifiers/{name}": {"get": {}, "put": {}}, "/challenges/{name}": '
                      '{"post": {"summary": "Sign challange message and forward to peer '
                      'identfiier", "description": "Sign a challenge word list received out of '
                      ...
                      'true, "content": {"application/json": {"schema": {"description": "Challenge '
                      'response", "properties": {"recipient": {"type": "string", "description": '
                      '"human readable alias recipient identifier to send signed challenge to"}, '
                      '"words": {"type": "array", "description": "challenge in form of word list", '
                      '"items": {"type": "string"}}}}}}}, "responses": {"202": {"description": '
                      '"Success submission of signed challenge/response"}}}, "put": {"summary": '
                      '"Mark challenge response exn message as signed", "description": "Mark '
                      'challenge response exn message as signed", "tags": ["Challenge/Response"], '
                      ...
                      '{"schema": {"description": "Challenge response", "properties": {"aid": '
                      '{"type": "string", "description": "aid of signer of accepted challenge '
                      'response"}, "said": {"type": "array", "description": "SAID of challenge '
                      'message signed", "items": {"type": "string"}}}}}}}, "responses": {"202": '
                      '{"description": "Success submission of signed challenge/response"}}}}, '
                      '"/contacts/{prefix}": {"delete": {"summary": "Delete contact information '
                      'associated with remote identfier", "description": "Delete contact '
                      'information associated with remote identfier", "tags": ["Contacts"], '
                      '"parameters": [{"in": "path", "name": "prefix", "schema": {"type": '
                      '"string"}, "required": true, "description": "qb64 identifier prefix of '
                      'contact to delete"}], "responses": {"202": {"description": "Contact '
                      'information successfully deleted for prefix"}, "404": {"description": "No '
                      'contact information found for prefix"}}}, "get": {"summary": "Get contact '
                      'information associated with single remote identfier", "description": "Get '
                      'contact information associated with single remote identfier.  All '
                      'information is meta-data and kept in local storage only", "tags": '
                      '["Contacts"], "parameters": [{"in": "path", "name": "prefix", "schema": '
                      '{"type": "string"}, "required": true, "description": "qb64 identifier prefix '
                      'of contact to get"}], "responses": {"200": {"description": "Contact '
                      'information successfully retrieved for prefix"}, "404": {"description": "No '
                      'contact information found for prefix"}}}, "post": {"summary": "Create new '
                      'contact information for an identifier", "description": "Creates new '
                      'information for an identifier, overwriting all existing information for that '
                      'identifier", "tags": ["Contacts"], "parameters": [{"in": "path", "name": '
                      '"prefix", "schema": {"type": "string"}, "required": true, "description": '
                      '"qb64 identifier prefix to add contact metadata to"}], "requestBody": '
                      ...
                      'identifier"}, "400": {"description": "Invalid identfier used to update '
                      'contact information"}, "404": {"description": "Prefix not found in '
                      'identifier contact information"}}}, "put": {"summary": "Update provided '
                      'fields in contact information associated with remote identfier prefix", '
                      '"description": "Update provided fields in contact information associated '
                      'with remote identfier prefix.  All information is metadata and kept in local '
                      'storage only", "tags": ["Contacts"], "parameters": [{"in": "path", "name": '
                      '"prefix", "schema": {"type": "string"}, "required": true, "description": '
                      '"qb64 identifier prefix to add contact metadata to"}], "requestBody": '
                      '{"required": true, "content": {"application/json": {"schema": '
                      '{"description": "Contact information", "type": "object"}}}}, "responses": '
                      ...
                      '"schema": {"type": "string"}, "required": true, "description": "qb64 said of '
                      'note to delete"}], "responses": {"202": {"description": "Notification '
                      ...
                      '{"post": {}}, "/contacts/{prefix}/img": {"get": {"summary": "Get contact '
                      'image for identifer prefix", "description": "Get contact image for identifer '
                      'prefix", "tags": ["Contacts"], "parameters": [{"in": "path", "name": '
                      '"prefix", "schema": {"type": "string"}, "required": true, "description": '
                      '"qb64 identifier prefix of contact image to get"}], "responses": {"200": '
                      '{"description": "Contact information successfully retrieved for prefix", '
                      '"content": {"image/jpg": {"schema": {"description": "Image", "type": '
                      '"binary"}}}}, "404": {"description": "No contact information found for '
                      'prefix"}}}, "post": {"summary": "Uploads an image to associate with '
                      'identfier.", "description": "Uploads an image to associate with identfier.", '
                      '"tags": ["Contacts"], "parameters": [{"in": "path", "name": "prefix", '
                      '"schema": {"type": "string"}, "description": "identifier prefix to associate '
                      'image to", "required": true}], "requestBody": {"required": true, "content": '
                      '{"image/jpg": {"schema": {"type": "string", "format": "binary"}}, '
                      '"image/png": {"schema": {"type": "string", "format": "binary"}}}}, '
                      '"responses": {"200": {"description": "Image successfully uploaded"}}}}, '
                      '"/oobi/{aid}/{role}": {"get": {}}, "/oobi/{aid}/{role}/{eid}": {"get": {}}, '
                      '"/identifiers/{name}/endroles/{cid}/{role}/{eid}": {"delete": {}}}, "info": '
