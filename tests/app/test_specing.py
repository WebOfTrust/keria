...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an '
                      ...
                      'database"}}}}, "/identifiers": {"get": {}, "post": {}}, "/challenges": {'
                      ...
                      'identfiers", "description": "Get list of contact information associated '
                      'with remote identfiers.  All information is metadata and kept in local '
                      'storage only", "tags": ["Contacts"], "parameters": [{"in": "query", '
                      '"name": "group", "schema": {"type": "string"}, "required": false, '
                      '"description": "field name to group results by"}, {"in": "query", '
                      '"name": "filter_field", "schema": {"type": "string"}, "description": '
                      '"field name to search", "required": false}, {"in": "query", '
                      '"name": "filter_value", "schema": {"type": "string"}, "description": '
                      '"value to search for", "required": false}], "responses": {"200": {'
                      '"description": "List of contact information for remote identifiers"}}}}, '
                      '"/notifications": {"get": {"summary": "Get list of notifcations for the '
                      'controller of the agent", "description": "Get list of notifcations for the '
                      'controller of the agent.  Notifications will be sorted by creation '
                      'date/time", "parameters": [{"in": "query", "name": "last", "schema": {'
                      '"type": "string"}, "required": false, "description": "qb64 SAID of last '
                      'notification seen"}, {"in": "query", "name": "limit", "schema": {"type": '
                      '"integer"}, "required": false, "description": "size of the result list.  '
                      'Defaults to 25"}], "tags": ["Notifications"], "responses": {"200": {'
                      '"description": "List of contact information for remote identifiers"}}}}, '
                      ...
                      '"description": "KEL EXN, QRY, RPY event accepted."}}}}, "/operations/{'
                      ...
                      '"type": "object"}}}}}}}, "/agent/{caid}": {"get": {}}, "/identifiers/{'
                      'name}": {"get": {}, "put": {}}, "/challenges/{name}": {"post": {"summary": '
                      '"Sign challange message and forward to peer identfiier", "description": '
                      '"Sign a challenge word list received out of bands and send `exn` peer to '
                      'peer message to recipient", "tags": ["Challenge/Response"], "parameters": '
                      '[{"in": "path", "name": "name", "schema": {"type": "string"}, "required": '
                      'true, "description": "Human readable alias for the identifier to '
                      'create"}], "requestBody": {"required": true, "content": {'
                      '"application/json": {"schema": {"description": "Challenge response", '
                      '"properties": {"recipient": {"type": "string", "description": "human '
                      'readable alias recipient identifier to send signed challenge to"}, '
                      '"words": {"type": "array", "description": "challenge in form of word '
                      'list", "items": {"type": "string"}}}}}}}, "responses": {"202": {'
                      '"description": "Success submission of signed challenge/response"}}}, '
                      '"put": {"summary": "Mark challenge response exn message as signed", '
                      '"description": "Mark challenge response exn message as signed", "tags": ['
                      ...
                      '"said": {"type": "array", "description": "SAID of challenge message '
                      'signed", "items": {"type": "string"}}}}}}}, "responses": {"202": {'
                      '"description": "Success submission of signed challenge/response"}}}}, '
                      ...
                      '"type": "string"}, "required": true, "description": "qb64 identifier '
                      'prefix of contact to get"}], "responses": {"200": {"description": "Contact '
                      'information successfully retrieved for prefix"}, "404": {"description": '
                      '"No contact information found for prefix"}}}, "post": {"summary": "Create '
                      'new contact information for an identifier", "description": "Creates new '
                      'information for an identifier, overwriting all existing information for '
                      'that identifier", "tags": ["Contacts"], "parameters": [{"in": "path", '
                      ...
                      'remote identifier"}, "400": {"description": "Invalid identfier used to '
                      ...
                      'with remote identfier prefix.  All information is metadata and kept in '
                      ...
                      'image for identifer prefix", "description": "Get contact image for '
                      ...
                      'uploaded"}}}}, "/oobi/{aid}/{role}": {"get": {}}, "/oobi/{aid}/{role}/{'
                      'eid}": {"get": {}}, "/identifiers/{name}/endroles/{cid}/{role}/{eid}": {'
                      '"delete": {}}}, "info": {"title": "KERIA Interactive Web Interface API", '
                      '"version": "1.0.1"}, "openapi": "3.1.0"}')
