...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an alias '
                      ...
                      '"/challenges": {"get": {"summary": "Get random list of words for a 2 factor '
                      'auth challenge", "description": "Get the list of identifiers associated with '
                      'this agent", "tags": ["Challenge/Response"], "parameters": [{"in": "query", '
                      '"name": "strength", "schema": {"type": "int"}, "description": "cryptographic '
                      'strength of word list", "required": false}], "responses": {"200": '
                      '{"description": "An array of random words", "content": {"application/json": '
                      '{"schema": {"description": "Random word list", "type": "object", '
                      ...
                      'of notifications for the controller of the agent", "description": "Get list '
                      'of notifications for the controller of the agent.  Notifications will be '
                      'sorted by creation date/time", "parameters": [{"in": "header", "name": '
                      '"Range", "schema": {"type": "string"}, "required": false, "description": '
                      '"size of the result list.  Defaults to 25"}], "tags": ["Notifications"], '
                      ...
                      '{"204": {"description": "KEL EXN, QRY, RPY event accepted."}}}, "put": '
                      ...
                      '"tags": ["Events"], "requestBody": {"required": true, "content": '
                      '{"application/json": {"schema": {"type": "object", "description": "KERI '
                      'event message"}}}}, "responses": {"200": {"description": "Mailbox query '
                      'response for server sent events"}, "204": {"description": "KEL or EXN event '
                      'accepted."}}}}, "/operations/{name}": {"delete": {}, "get": {}}, '
                      '"/oobis/{alias}": {"get": {"summary": "Get OOBI for specific identifier", '
                      '"description": "Generate OOBI for the identifier of the specified alias and '
                      'role", "tags": ["OOBIs"], "parameters": [{"in": "path", "name": "alias", '
                      '"schema": {"type": "string"}, "required": true, "description": "human '
                      'readable alias for the identifier generate OOBI for"}, {"in": "query", '
                      '"name": "role", "schema": {"type": "string"}, "required": true, '
                      '"description": "role for which to generate OOBI"}], "responses": {"200": '
                      '{"description": "An array of Identifier key state information", "content": '
                      '{"application/json": {"schema": {"description": "Key state information for '
                      'current identifiers", "type": "object"}}}}}}}, "/agent/{caid}": {"get": {}, '
                      '"put": {}}, "/identifiers/{name}": {"get": {}, "put": {}}, '
                      '"/endroles/{aid}": {"get": {}, "post": {}}, "/escrows/rpy": {"get": {}}, '
                      '"/challenges/{name}": {"post": {"summary": "Sign challenge message and '
                      ...
                      '"tags": ["Challenge/Response"], "parameters": [{"in": "path", "name": '
                      '"name", "schema": {"type": "string"}, "required": true, "description": '
                      ...
                      '"string", "description": "human readable alias recipient identifier to send '
                      'signed challenge to"}, "words": {"type": "array", "description": "challenge '
                      'in form of word list", "items": {"type": "string"}}}}}}}, "responses": '
                      '{"202": {"description": "Success submission of signed '
                      ...
                      '"qb64 identifier prefix of contact to delete"}], "responses": {"202": '
                      '{"description": "Contact information successfully deleted for prefix"}, '
                      '"404": {"description": "No contact information found for prefix"}}}, "get": '
                      '{"summary": "Get contact information associated with single remote '
                      'identifier", "description": "Get contact information associated with single '
                      'remote identifier.  All information is meta-data and kept in local storage '
                      'only", "tags": ["Contacts"], "parameters": [{"in": "path", "name": "prefix", '
                      '"schema": {"type": "string"}, "required": true, "description": "qb64 '
                      'identifier prefix of contact to get"}], "responses": {"200": {"description": '
                      '"Contact information successfully retrieved for prefix"}, "404": '
                      '{"description": "No contact information found for prefix"}}}, "post": '
                      '{"summary": "Create new contact information for an identifier", '
                      '"description": "Creates new information for an identifier, overwriting all '
                      'existing information for that identifier", "tags": ["Contacts"], '
                      ...
                      'identifier used to update contact information"}, "404": {"description": '
                      ...
                      'identifier prefix", "description": "Update provided fields in contact '
                      'information associated with remote identifier prefix.  All information is '
                      ...
                      'associate with identifier.", "description": "Uploads an image to associate '
                      'with identifier.", "tags": ["Contacts"], "parameters": [{"in": "path", '
                      ...
                      '"/challenges/{name}/verify/{source}": {"post": {"summary": "Sign challenge '
                      'message and forward to peer identifier", "description": "Sign a challenge '
                      'word list received out of bands and send `exn` peer to peer message to '
                      'recipient", "tags": ["Challenge/Response"], "parameters": [{"in": "path", '
                      ...
                      '"Success submission of signed challenge/response"}}}}, '
