...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an '
                      ...
                      'database"}}}}, "/health": {"get": {}}, "/identifiers": {"get": {}, '
                      '"options": {}, "post": {}}, "/challenges": {"get": {"summary": "Get list '
                      'of agent identifiers", "description": "Get the list of identifiers '
                      ...
                      '"responses": {"200": {"description": "An array of Identifier key state '
                      'information", "content": {"application/json": {"schema": {"description": '
                      '"Randon word list", "type": "object", "properties": {"words": {"type": '
                      '"array", "description": "random challange word list", "items": {"type": '
                      ...
                      'notifcations for the controller of the agent.  Notifications will be '
                      'sorted by creation date/time", "parameters": [{"in": "query", '
                      '"name": "last", "schema": {"type": "string"}, "required": false, '
                      '"description": "qb64 SAID of last notification seen"}, {"in": "query", '
                      ...
                      'RPY event accepted."}}}}, "/operations/{name}": {"delete": {}, "get": {}}, '
                      '"/oobis/{alias}": {"get": {"summary": "Get OOBI for specific identifier", '
                      '"description": "Generate OOBI for the identifier of the specified alias '
                      'and role", "tags": ["OOBIs"], "parameters": [{"in": "path", '
                      '"name": "alias", "schema": {"type": "string"}, "required": true, '
                      '"description": "human readable alias for the identifier generate OOBI '
                      'for"}, {"in": "query", "name": "role", "schema": {"type": "string"}, '
                      '"required": true, "description": "role for which to generate OOBI"}], '
                      '"responses": {"200": {"description": "An array of Identifier key state '
                      'information", "content": {"application/json": {"schema": {"description": '
                      '"Key state information for current identifiers", "type": "object"}}}}}}}, '
                      '"/agent/{caid}": {"get": {}, "put": {}}, "/identifiers/{name}": {"get": {'
                      '}, "put": {}}, "/endroles/{aid}": {"get": {}, "post": {}}, "/escrows/rpy": '
                      '{"get": {}}, "/challenges/{name}": {"post": {"summary": "Sign challange '
                      'message and forward to peer identfiier", "description": "Sign a challenge '
                      ...
                      '"Delete contact information associated with remote identfier", '
                      '"description": "Delete contact information associated with remote '
                      'identfier", "tags": ["Contacts"], "parameters": [{"in": "path", '
                      ...
                      'with single remote identfier", "description": "Get contact information '
                      'associated with single remote identfier.  All information is meta-data and '
                      'kept in local storage only", "tags": ["Contacts"], "parameters": [{"in": '
                      '"path", "name": "prefix", "schema": {"type": "string"}, "required": true, '
                      ...
                      'prefix to add contact metadata to"}], "requestBody": {"required": true, '
                      '"content": {"application/json": {"schema": {"description": "Contact '
                      'information", "type": "object"}}}}, "responses": {"200": {"description": '
                      '"Updated contact information for remote identifier"}, "400": {'
                      '"description": "Invalid identfier used to update contact information"}, '
                      '"404": {"description": "Prefix not found in identifier contact '
                      'information"}}}, "put": {"summary": "Update provided fields in contact '
                      'information associated with remote identfier prefix", "description": '
                      '"Update provided fields in contact information associated with remote '
                      'identfier prefix.  All information is metadata and kept in local storage '
                      'only", "tags": ["Contacts"], "parameters": [{"in": "path", '
                      '"name": "prefix", "schema": {"type": "string"}, "required": true, '
                      ...
                      'identfier.", "description": "Uploads an image to associate with '
                      'identfier.", "tags": ["Contacts"], "parameters": [{"in": "path", '
                      ...
                      'name}/endroles/{role}": {"get": {}, "post": {}}, "/oobi/{aid}/{role}/{'
                      'eid}": {"get": {}}, "/identifiers/{name}/endroles/{role}/{eid}": {'
