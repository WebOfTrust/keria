...
def test_spec_resource(helpers):
    with helpers.openKeria() as (agency, agent, app, client):
        ...
        assert js == ('{"paths": {"/oobis": {"post": {"summary": "Resolve OOBI and assign an alias '
                      ...
                      'identfier", "tags": ["Contacts"], "parameters": [{"in": "path", "name": '
                      ...
                      'identfier", "description": "Get contact information associated with single '
                      'remote identfier.  All information is meta-data and kept in local storage '
                      ...
                      '"/challenges/{name}/verify/{source}": {"post": {"summary": "Sign challange '
